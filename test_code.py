...
# Initialize the CSV file name and document path
csv_file = "quiz_questions.csv"
questions_folder = "questions"

# Prepare to store processed questions
processed_questions = []
...
with open(csv_file, mode="w", newline="", encoding="utf-8") as file:
    ...
    # Write header with an additional 'Explanation' column
    writer.writerow(
        [
            "S.No",
            "Question",
    ...
    for question_paragraphs in processed_questions:
        ...
        for para in question_paragraphs:
            ...
            for run in para.runs:
                if run.italic and not answer_found:
                    ...
                    section_index = explanation.find("Section")
                    if section_index != -1:
        ...
        if "True or False" in question_text:
            ...
            row = [question_text]  # Start with the question text
...
"""
# print seperate column for sn number
